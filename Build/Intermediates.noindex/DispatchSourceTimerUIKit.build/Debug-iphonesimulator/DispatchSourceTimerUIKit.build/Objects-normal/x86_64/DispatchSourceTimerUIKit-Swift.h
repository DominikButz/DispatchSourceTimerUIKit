...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DispatchSourceTimerUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24DispatchSourceTimerUIKit11AppDelegate")
...
SWIFT_CLASS("_TtC24DispatchSourceTimerUIKit25LaunchTimerViewController")
@interface LaunchTimerViewController : UIViewController
- (void)viewDidLoad;
- (void)launchTimerVC;
...
SWIFT_CLASS("_TtC24DispatchSourceTimerUIKit13SceneDelegate")
...
SWIFT_CLASS("_TtC24DispatchSourceTimerUIKit20SecondViewController")
...
SWIFT_CLASS("_TtC24DispatchSourceTimerUIKit16TabBarController")
...
SWIFT_CLASS("_TtC24DispatchSourceTimerUIKit19TimerViewController")
@interface TimerViewController : UIViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)didTapTimerButton:(UIButton * _Nonnull)sender;
- (void)didTapAbortButton:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
